...
function Home(){
    ...
    return (
        <>
            <Header />
            <div className='border border-red-400 flex flex-col place-content-start min-h-screen relative -z-50'>
                    ...
                    <div className='text-white  flex place-content-between px-4 mt-5'>
                        ...
                        <div className='font-bold tracking-[0.2rem] text-sm whitespace-normal text-left w-1/2'>
